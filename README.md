...
Implementations compared: Naive Python version (triplet loops). Optimized Python version (iterate only on relevant pairs). Vectorized PyTorch version (parallel GPU computation).
